...
def main():
    ...
    # This is a speed-oriented training configuration.
    parser.add_argument("--epochs", type=int, default=70)
    parser.add_argument("--batch-size", type=int, default=512)
    parser.add_argument("--workers", type=int, default=4)
    parser.add_argument("--max-lr", type=float, default=0.2)

    # Do not spend time evaluating every epoch.
    ...
    if args.demo:
        ...
        print(f"Demo inference accuracy: {100 * before:.2f}%")
        ...
        # A one-epoch scheduler is required only so the same train function
